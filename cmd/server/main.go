...
func main() {
	...
	stateMachine := domain.StateMachine{Node: node, Log: []domain.Log{}, HeartbeatWatch: heartbeatWatch, CurrentTerm: 0, Role: "follower", CommitIndex: 0, LastApplied: 0, NextIndex: make(map[string]int), MatchIndex: make(map[string]int)}
